...
<head>
    ...
    <title>Recuperar Contraseña | Dirección de Educación Superior</title>
    ...
    <style>
        .reduce-margin {
            margin-bottom: 10px; /* Ajusta el espacio entre los elementos según sea necesario */
        }
    </style>
</head>
<body>
                        ...
                        <div class="content content-full">
                            ...
                            <div class="text-center mb-20">
                                ...
                                <div class="subtitle-container">
                                    <br>
                                    <h1 class="h3 font-w700 reduce-margin">No te preocupes, te respaldamos</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0 reduce-margin">Por favor ingrese su correo electrónico</h2>
                                </div>
                            </div>
                            <div class="px-30">
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-sm btn-hero btn-alt-primary" id="btnrecuperar">
                                        <i class="si si-login mr-10"></i> Recuperar contraseña
                                    </button>
                                    <div class="mt-30">
                                        <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="../">
                                            <i class="fa fa-plus mr-5"></i> Inicio de sesión
                                        </a>
                                    </div>
                                </div>
                            </div>
