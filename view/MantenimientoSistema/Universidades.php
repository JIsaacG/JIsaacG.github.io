        ...
        <main id="main-container">
            ...
            <div class="content">
                <h2 class="content-heading">Bienvenido, UNITEC </h2>
                        ...
                        <h3 class="block-title">Universidades <small></small></h3>
                    </div>
...
<html>
<head>
    <title>Tabla de Universidades</title>
    <style>
        table {
            width: 100%;
...
echo '<th>Nombre Universidad</th>';
echo '<th>ID Departamento</th>';
echo '<th>Acción</th>';
echo '</tr>';

// Si hay universidades, las mostramos
if (!empty($universidades)) {
    foreach ($universidades as $universidad) {
        echo '<tr>';
        echo '<td>' . $universidad['IDuniversidad'] . '</td>';
        echo '<td>' . $universidad['NombreUniversidad'] . '</td>';
        echo '<td>' . $universidad['IDdepartamento'] . '</td>';
        echo '<td class="action-buttons">';
        echo '<form action="editar.php" method="POST">';
        echo '<input type="hidden" name="IDuniversidad" value="' . $universidad['IDuniversidad'] . '">';
        echo '<input type="hidden" name="IDdepartamento" value="' . $universidad['IDdepartamento'] . '">';
        echo '<input type="submit" value="Editar">';
        echo '</form>';
        echo '<form action="eliminar.php" method="POST">';
        echo '<input type="hidden" name="IDuniversidad" value="' . $universidad['IDuniversidad'] . '">';
        echo '<input type="hidden" name="IDdepartamento" value="' . $universidad['IDdepartamento'] . '">';
        echo '<input type="submit" value="Eliminar" onclick="return confirm(\'¿Estás seguro de que quieres eliminar esta universidad?\');">';
        echo '</form>';
        echo '</td>';
        echo '</tr>';
    }
