    ...
    <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
        ...
        <main id="main-container">
            ...
            <div class="content">
                ...
                <h3 class="block-title">Categorias De Solicitudes <small></small></h3>
                    </div>
...
echo '<th>Código de Arbitrios</th>';
echo '<th>Nombre Categoría</th>';
echo '<th>ID Tipo Solicitud</th>';
echo '<th>Monto</th>';
echo '<th>Acción</th>';
echo '</tr>';
...
if (!empty($categorias)) {
    foreach ($categorias as $categoria) {
        ...
        echo '<td>' . $categoria['CodigoArbitrios'] . '</td>';
        echo '<td>' . $categoria['NombreCategoria'] . '</td>';
        echo '<td>' . $categoria['IDtipoSolicitud'] . '</td>';
        echo '<td>' . $categoria['Monto'] . '</td>';
        echo '<td class="action-buttons">';
        echo '<form action="editar.php" method="POST">';
        echo '<input type="hidden" name="IDcategoria" value="' . $categoria['IDcategoria'] . '">';
        echo '<input type="hidden" name="IDtipoSolicitud" value="' . $categoria['IDtipoSolicitud'] . '">';
        echo '<input type="submit" value="Editar">';
        echo '</form>';
        echo '<form action="eliminar.php" method="POST">';
        echo '<input type="hidden" name="IDcategoria" value="' . $categoria['IDcategoria'] . '">';
        echo '<input type="hidden" name="IDtipoSolicitud" value="' . $categoria['IDtipoSolicitud'] . '">';
        echo '<input type="submit" value="Eliminar" onclick="return confirm(\'¿Estás seguro de que quieres eliminar esta categoría?\');">';
        echo '</form>';
        echo '</td>';
        echo '</tr>';
    }
    ...
    echo '<td class="action-buttons">';
    echo '<form action="editar.php" method="POST">';
    echo '<input type="hidden" name="IDcategoria" value="">';
    echo '<input type="hidden" name="IDtipoSolicitud" value="">';
    echo '<input type="submit" value="Editar">';
    echo '</form>';
    echo '<form action="eliminar.php" method="POST">';
    echo '<input type="hidden" name="IDcategoria" value="">';
