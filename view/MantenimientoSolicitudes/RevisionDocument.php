                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell">
                                        <span class="badge badge-danger">Revisión de documentación</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell">Licenciatura</td>
                                    <td class="d-none d-sm-table-cell">
                                        <span class="badge badge-success">Subsanación realizada </span>
                                    </td>
                                    <td class="text-center">
                                        <a href="../NuevoIngresoSolicitud/">
                                            <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Proceso">
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell">Licenciatura</td>
                                    <td class="d-none d-sm-table-cell">
                                        <span class="badge badge-danger">Pendiente de subsanación</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="../NuevoIngresoSolicitud/">
                                            <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Proceso">
