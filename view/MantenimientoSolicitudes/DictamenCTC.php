            ...
            <div class="content">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/DictamenCTC_Agenda.php" class="block block-link-shadow text-center">
                    ...
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/DictamenCTC_Asignar.php" class="block block-link-shadow text-center">
                            <div class="block-content block-content-full">
                                <div class="py-30 text-center">
