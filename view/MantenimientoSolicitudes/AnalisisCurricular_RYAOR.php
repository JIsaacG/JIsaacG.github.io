            ...
            <div class="content">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/AnalisisCurricular_DGAC.php" class="block block-link-shadow text-center">
                    ...
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/AnalisisCurricular_DirecE.php" class="block block-link-shadow text-center">
                            <div class="block-content block-content-full">
                                <div class="py-30 text-center">
