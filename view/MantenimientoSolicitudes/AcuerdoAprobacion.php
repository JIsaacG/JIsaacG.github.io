...
<body>
    ...
    <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
        ...
        <main id="main-container">
            <div class="content">
                <h2 class="content-heading">Acuerdo de Aprobación</h2>

                <div class="row justify-content-center">
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/AcuerdoApro_Agenda.php" class="block block-link-shadow text-center">
                    ...
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/AcuerdoApro_Asignar.php" class="block block-link-shadow text-center">
                            <div class="block-content block-content-full">
                                <div class="py-30 text-center">
